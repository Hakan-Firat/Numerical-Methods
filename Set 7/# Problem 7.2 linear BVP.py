...
x1, x2 = 0, 1
u1, u2 = 1.2, 0.9
v_guess = -1  # Initial guess 

x_vals, u_vals, iterates, v_final = solve_by_shooting(linear_g, x1, x2, u1, u2, v_guess)

print(f"Computed initial derivative v'(0) for linear BVP: {v_final}")
...
plt.ylabel('u(x)')
plt.legend()
plt.title('Shooting Method Iterations (Linear)')
plt.show()
